	...
	<body class="landing">
			...
			<header id="header">
				...
				<nav id="nav">
					<ul>
						...
						<li><a href="admin_login.php" class="button special"><b>Login</b></a></li>
		...
		<!-- Banner -->
			<section id="banner">
				...
				<ul class="actions">
					<li>
					<p>Login now as an admin to view data</p>
					</li>
					<li>		
					</li>
			...
			<section id="one" class="wrapper style1 special">
				<div class="container">
					<header class="major">
						<h2>Categories to get yourself hired</h2>
						<p> Find the opportunities waiting for you</p>
					</header>
					<div class="row 150%">
						<div class="4u 12u$(medium)">
							<section class="box">
								...
								<p>This field covers a wide field of Computer Science and Information technology</p>
							</section>
						</div>
						<div class="4u 12u$(medium)">
							<section class="box">
								...
								<h3>Marketing</h3>
								<p>This field covers Marketing in general aspects</p>
							</section>
						</div>
						<div class="4u$ 12u$(medium)">
							<section class="box">
